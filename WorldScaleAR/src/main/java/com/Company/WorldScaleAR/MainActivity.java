...
public class MainActivity extends Activity implements View.OnClickListener {
    ...
    private Button mPlayBtn, mResumeBtn, mPauseBtn, mStopBtn, mMoveToBtn, mUnityBtn;
    ...
    void initUI() {
        ...
        mUnityBtn.setOnClickListener(unityPlay);

    }

    private Button.OnClickListener unityPlay = new Button.OnClickListener(){
        @Override
